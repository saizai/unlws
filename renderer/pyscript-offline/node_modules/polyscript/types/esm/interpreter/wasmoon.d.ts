declare namespace _default {
    ...
    export function engine({ LuaFactory, LuaLibraries }: {
        LuaFactory: any;
        LuaLibraries: any;
    }, config: any, _: any, baseURL: any): Promise<any>;
    export function registerJSModule(interpreter: any, name: any, value: any): void;
    export function run(interpreter: any, code: any, ...args: any[]): any;
    export function runAsync(interpreter: any, code: any, ...args: any[]): Promise<any>;
